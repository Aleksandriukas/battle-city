...
public final class CONSTANTS {
    public static Integer TILE_SIZE = 16;
    public static Integer MAP_SIZE = 256;
    public static Integer SCREEN_WIDTH = 320;
    public static Integer SCREEN_HEIGHT = 240;
    public static Integer TANK_MODEL_SIZE = 13;
    public static Integer TANK_TILE_SIZE = 16;
    public static Integer BULLET_TILE_SIZE = 8;
    public static Integer BULLET_MODEL_SIZE = 3;
    public static int[] RIGHT_HALF_BRICK = new int[]{2,0};
    public static int[] LEFT_HALF_BRICK = new int[]{4,0};
